...
func TestOpenFiles(t *testing.T) {
	g := NewGame("rnbqkbnr/p1ppp1p1/8/8/8/8/P1P1PPP1/RNBQKBNR w KQkq - 0 1", 0, 0, 0)
...
func TestCountFiguresMoves(t *testing.T) {
	g := NewGame("8/8/4k3/3R4/2K5/8/8/8 w - - 0 1", 0, 0, 0)
	...
	g = NewGame("8/8/4k3/3R4/2K5/8/8/8 b - - 0 1", 0, 0, 0)
